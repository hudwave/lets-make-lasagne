...
You can read more about how the closure function works in the [Appendix](/appendix-gamemaker-patterns/appendix-gamemaker-patterns.md#a-closures). But for now you can trust this works so lets look at how this changes the `data_bind` code.
